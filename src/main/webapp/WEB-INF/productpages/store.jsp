...
<c:set var="pageTitle" value="宣传品库存" scope="request" />
    ...
    <div class="content">     
        <div class="container-fluid">
        	<ul class="nav nav-tabs" style="margin-top:20px">
			    ...
			    <li  class="active"><a href="${storeUrl }">宣传品库存</a></li>
                ...
                <div class="row-fluid table">
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${stores}" var="store">
                        	<tr>
                        		<td>
                        			<c:url var ="proUrl" value = "/manager/productpages/profile?id=${store.page.id }"></c:url>
	                                <a href="${proUrl }" class="name">${store.page.name }</a>
	                            </td>
	                            <td>
	                                ${store.count }
	                            </td>
