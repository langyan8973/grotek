...
<c:set var="pageTitle" value="新增员工" scope="request" />
            ...
            <div class="settings-wrapper" id="pad-wrapper">
                ...
                <div class="span7 personal-info">
                    ...
                    <h5 class="personal-title">员工信息</h5>
                        ...
                        <div class="field-box">
                            <label>姓名:</label>
                            <input id="fullname" name="fullname" class="span5 inline-input" type="text" value="" />
                            <span class="help-inline"></span>
                        </div>
                        <div class="field-box">
                            <label>编码:</label>
                            <input id="code" name="code" class="span5 inline-input" type="text" value="" />
                            <span class="help-inline"></span>
                        </div>
                        <div class="field-box">
                            <label>性别:</label>
                            <div class="ui-select">
                                <select id="sex" name="sex" value="男">
                        ...
                        <div class="field-box">
                            <label>地址:</label>
                            <input id="address" name="address" class="span5 inline-input" type="text" value="" />
                            <span class="help-inline"></span>
                        </div>
                        <div class="field-box">
                            <label>手机号:</label>
                            <input id="mobile" name="mobile" class="span5 inline-input" type="text" value="" onkeyup="clearNoNum(this)"/>
                            <span class="help-inline"></span>
                        </div>
                        <div class="field-box">
                            <label>邮编:</label>
                            <input id="postcode" name="postcode" class="span5 inline-input" type="text" value="" onkeyup="clearNoNum(this)"/>
                            <span class="help-inline"></span>
                        </div>
                        <div class="field-box">
                            <label>固定电话:</label>
                            <input id="phone" name="phone" class="span5 inline-input" type="text" value="" onkeyup="clearNoNum(this)"/>
                            <span class="help-inline"></span>
                        </div>
                        <div class="field-box">
                            <label>职位:</label>
                        ...
                        <div class="field-box">
                            <label>主管领导:</label>
                            <input id="sname" name="sname" class="span5 inline-input" type="text" value=""/>
                            <span class="help-inline"></span>
                        </div>
                        <input type="hidden" name="superior" id="superior"/>
                        <input type="hidden" name="headimg" id="headimg"/>
                        <input type="hidden" name="regform" id="regform"/>
