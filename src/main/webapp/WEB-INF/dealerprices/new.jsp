...
<c:set var="pageTitle" value="新增经销商价格" scope="request" />
            ...
            <form id="add-form" class="form-horizontal" action="${addUrl }" method="post" enctype="multipart/form-data">
	            ...
	            <div class="settings-wrapper" id="pad-wrapper">
	                ...
	                <div class="span8 personal-info">
	                    <h5 class="personal-title">经销商价格</h5>
	                        ...
	                        <div class="field-box">
	                            <label>产品:</label>
	                            <input id="bname" name="bname" class="span5 inline-input" type="text" value="${box.name }"/>
	                            <span class="help-inline"></span>
	                            <input id="bid" name="bid" class="span5 inline-input" type="hidden" value="${box.id }"/>
	                        </div>
	                        <div class="field-box">
	                            <label>价格(元):</label>
	                            <input id="price" name="price" class="span5 inline-input" type="text" value="" onkeyup="clearNoNum(this)"/>
	                            <span class="help-inline"></span>
	    ...
	    <div class="modal fade" id="myModal" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body" id="treeChooseproductBoxId">
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">
							关闭
...
$(document).ready(
		function() {
			...
			$('#bname').bind('click', function() {
				$('#myModal').modal( {
					keyboard : false
				})
			});
			$('#treeChooseproductBoxId').load('<c:url value="/manager/productboxes/select" />');
...
function clickBoxNote(id,sname){
	$('#bname').val(sname);
	$('#bid').val(id);
	$('#myModal').modal('hide');
}
