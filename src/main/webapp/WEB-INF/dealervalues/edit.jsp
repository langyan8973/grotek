...
<c:set var="pageTitle" value="编辑表现评价" scope="request" />
	            ...
	            <div class="settings-wrapper" id="pad-wrapper">
	                ...
	                <div class="span8 personal-info">
	                    <h5 class="personal-title">支持费用和表现评价</h5>
	                        ...
	                        <div class="field-box">
	                            <label>经销商:</label>
	                            <input id="dname" name="dname" class="span5 inline-input" type="text" value="${dvalue.dealer.name }" />
	                            <span class="help-inline"></span>
	                            <input id="did" name="did" class="span5 inline-input" type="hidden" value="${dvalue.dealer.id }"/>
	                        </div>
	                        <div class="field-box">
	                            <label>让利金额:</label>
	                            <input id="promote" name="promote" class="span5 inline-input" type="text" value="${dvalue.promote }" onkeyup="clearNoNum(this)"/>
	                            <span class="help-inline"></span>
	                            <input id="id" name="id" type="hidden"  value="${dvalue.id }"/>
	                        </div>
	                        <div class="field-box">
	                            <label>返点金额:</label>
	                            <input id="rebate" name="rebate" class="span5 inline-input" type="text" value="${dvalue.rebate }" onkeyup="clearNoNum(this)"/>
	                            <span class="help-inline"></span>
	                        </div>
	                        <div class="field-box">
	                            <label>奖励金额:</label>
	                            <input id="reward" name="reward" class="span5 inline-input" type="text" value="${dvalue.reward }" onkeyup="clearNoNum(this)"/>
	                            <span class="help-inline"></span>
	                        </div>
	                        
	                        <div class="field-box">
	                            <label>表现评价:</label>
	                            <textarea rows="5" path="description" name='description' id="description" class="span5" placeholder="简要评价，50字以内" maxlength="50">${dvalue.description }</textarea>
	                            <span class="help-inline"></span>
	                        </div>
