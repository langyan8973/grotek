    ...
    <div class="row-fluid login-wrapper">
        <div class="box">
            <div class="content-wrap">
                <h6>管理员</h6>
                <c:url value="/manager/j_spring_security_check" var="nloginUrl" />
                ...
                <input class="span12" type="text" id="username" name="username" placeholder="用户名" required autofocus/>
                <input class="span12" type="password" id="password" name="password" placeholder="密码"  required/>
                <div class="checkbox">
