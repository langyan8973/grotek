    ...
    <div class="content wide-content">
        <div class="container-fluid">
        	<ul class="nav nav-tabs" style="margin-top:20px">
			    ...
			    <li class="active"><a href="${applyUrl }">发货申请</a></li>
			</ul> 
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    <h3>${employee.fullname }发货申请</h3>
...
$(document).ready(function() {
	...
	kkpager.generPageHtml({
		...
		getLink : function(n){
			...
			return this.hrefFormer + "?eid=${employee.id }&context="+ encodeURIComponent(text) + "&page=" + (n-1) + "&size=" + size;
		}
...
function search(){
	var text = $("#searchtext").val();
		window.location.href = '<c:url value="sends" />?eid=${employee.id }&context='+encodeURIComponent(text);
}
