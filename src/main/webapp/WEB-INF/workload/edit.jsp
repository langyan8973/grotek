...
<c:set var="pageTitle" value="编辑员工项目工作" scope="request" />
            ...
            <form id="weekly" class="form-horizontal" action="${addUrl }" method="post">
	            ...
	            <div class="settings-wrapper" id="pad-wrapper">
	            	<div class="span12 personal-info">
	                    <h5 class="personal-title">${em.fullname }周项目工作</h5>
	                        <div class="field-box span11">
			                     ...
			                     <!-- recent orders table -->
			                     <table id="itemtable" class="table table-bordered span11">
			                         <thead>
			                             <tr>
			                                 <th class="span2">
			                                     客户
...
$(document).ready(
		function() {
			...
			$('#treeChoosetypeBoxId').load('<c:url value="/manager/workload/jobtypes" />');
});
