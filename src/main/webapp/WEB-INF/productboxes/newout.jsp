	            ...
	            <div class="settings-wrapper" id="pad-wrapper">
	                ...
	                <div class="span8 personal-info">
	                    ...
	                    <h5 class="personal-title">${box.name }</h5>
	                        ...
	                        <div class="field-box">
	                            <label>付款状况:</label>
	                            <input type="text" class="span5 inline-input" name="paystatus" id="paystatus" placeholder="输入付款状况" 
									style="IME-MODE: disabled;"  maxlength="20" value=""/>
	                            <span class="help-inline"></span>
	                        </div>
	                        <div class="field-box">
	                            <label>付款额:</label>
	                            <input type="text" class="span5 inline-input" name="amountpaid" id="amountpaid" placeholder="输入付款额" 
