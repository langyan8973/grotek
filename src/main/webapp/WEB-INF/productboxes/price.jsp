...
<c:set var="pageTitle" value="产品价格" scope="request" />
    ...
    <div class="content">     
        <div class="container-fluid">
        	<ul class="nav nav-tabs" style="margin-top:20px">
			    ...
			    <li class="active"><a href="${priceUrl }">产品价格</a></li>
            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        ...
                        <c:url var="exUrl" value="/manager/productboxes/priceexport"></c:url>
                ...
                <div class="row-fluid table">
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${prices}" var="price">
                        	<tr>
                        		<td>
                        			<c:url var ="proUrl" value = "/manager/productboxes/profile?id=${price.box.id }"></c:url>
	                                <a href="${proUrl }" class="name">${price.box.name }</a>
	                            </td>
	                             <td>
	                                ${price.box.specification }
	                            </td>
	                            <td>
	                                ${price.unitprice }
	                            </td>
	                            ...
	                            <td>
	                                ${price.dealerUnitprice }
	                            </td>
	                            <td>
	                                ${price.dealerPieceprice }
	                            </td>
	                             <td>
	                                ${price.retailUnitprice }
	                            </td>
	                            <td>
	                                <fmt:formatDate value='${price.updateDate }'
