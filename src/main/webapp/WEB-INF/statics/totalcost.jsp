...
<body style="background-color:#ffffff;">
        ...
        <div id="pad-wrapper" class="user-profile">
            ...
            <div class="row-fluid header boxbottomline">
            	<c:if test="${employee != null}">
            		<div class="span4">
                     <h3 class="name">${employee.fullname }总费用统计</h3>
                 	</div>
            ...
            <div class="row-fluid profile">
            	...
            	<div id="canvas-holder1" class="span5" style="text-align:center;">
	...
	<script>
		...
		function search() {
			var eid = $('#eid').val();
			var url = '<c:url value="totalcost.json" />';
