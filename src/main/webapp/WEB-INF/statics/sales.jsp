...
<body style="background-color:#ffffff;">
        ...
        <div id="pad-wrapper" class="user-profile">
            ...
            <div class="row-fluid header boxbottomline">
            	<c:if test="${employee != null}">
            		<div class="span4">
                     <h3 class="name">${employee.fullname }工作业绩统计</h3>
                 	</div>
	...
	<script>
		$(document).ready(function() {
			$('#starttime').val(moment(new Date()).subtract(180, 'day').format("YYYY-MM"));
		...
		function search() {
			var eid = $('#eid').val();
			var url = '<c:url value="sales.json" />';
