...
<c:set var="pageTitle" value="包材库存" scope="request" />
    ...
    <div class="content">     
        <div class="container-fluid">
        	<ul class="nav nav-tabs" style="margin-top:20px">
			    ...
			    <li class="active"><a href="${storeUrl }">包材库存</a></li>
                ...
                <div class="row-fluid table">
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${stores}" var="store">
                        	<tr>
                        		<td>
                        			<c:url var ="proUrl" value = "/manager/productpacks/profile?id=${store.pack.id }"></c:url>
	                                <a href="${proUrl }" class="name">${store.pack.name }</a>
	                            </td>
	                            <td>
	                                ${store.count }
	                            </td>
