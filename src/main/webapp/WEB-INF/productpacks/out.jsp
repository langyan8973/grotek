...
<c:set var="pageTitle" value="包材出库" scope="request" />
    ...
    <div class="content">     
        <div class="container-fluid">
        	<ul class="nav nav-tabs" style="margin-top:20px">
			    ...
			    <li class="active"><a href="${outUrl }">包材出库</a></li>
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${outs}" var="out">
                        	<tr>
                        		...
                        		<td>
                        			<c:url var ="proUrl" value = "/manager/productraws/profile?id=${out.pack.id }"></c:url>
	                                <a href="${proUrl }" class="name">${out.pack.name }</a>
	                            </td>
	                            <td>
	                                ${out.count }
	                            </td>
