...
<link rel="stylesheet" href="${cssUrlp }" type="text/css" media="screen" />
    ...
    <div class="content">     
        <div class="container-fluid">
        	<ul class="nav nav-tabs" style="margin-top:20px">
        		<c:url var="listUrl" value="/manager/aexsforms/checkpending"></c:url>
			    <li class="active"><a href="${listUrl }">待审批的市场开拓费用报销单</a></li>
			    <c:url var="priceUrl" value="/manager/aexsforms/checked"></c:url>
			    <li><a href="${priceUrl }">已审批的市场开拓费用报销单</a></li>
			</ul>  
    ...
    <div class="modal hide fade" id="deny-modal" data-backdrop="static" data-keyboard="false">
		<c:url var="denyUrl" value="denyexs" />
