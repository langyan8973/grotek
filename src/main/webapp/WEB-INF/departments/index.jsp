...
<c:set var="pageTitle" value="部门管理" scope="request" />
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${departments}" var="dept">
                        	<tr>
	                            ...
	                            <td>
	                                <a id="editdept" class="btn btn-mini btn-warning"  href="javascript:edit(${dept.id },'${dept.name }','${dept.code }')">
										编辑
									</a>
									<button class="btn btn-mini btn-danger" type="button" onclick="deleteOne(${dept.id})">删除</button></td>
	                            </td>
	                        </tr>
                        </c:forEach>
                        </tbody>
		...
		<form id="adddept-form" class="form-horizontal" action="${adddeptUrl }" method="post" enctype="multipart/form-data">
			...
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="span3" name="name" id="name" placeholder="输入部门名称" 
						style="IME-MODE: disabled;"  maxlength="20"/>
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="code">部门编码</label>
					<div class="controls">
						<input type="text" class="span3" name="code" id="code" placeholder="输入部门编码" 
		...
		<form id="editdept-form" class="form-horizontal" action="${editdeptUrl }" method="post" enctype="multipart/form-data">
			...
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="span3" name="ename" id="ename" placeholder="输入部门名称" 
						style="IME-MODE: disabled;"  maxlength="20"/>
						<span class="help-inline"></span>
					</div>
				</div>
				<div class="control-group">
					<label class="control-label" for="code">部门编码</label>
					<div class="controls">
						<input type="text" class="span3" name="ecode" id="ecode" placeholder="输入部门编码" 
						style="IME-MODE: disabled;" onkeyup="value=value.replace(/[\W]/g,'') "
						onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))" maxlength="20"/>
						<span class="help-inline"></span>
					</div>
