    ...
    <div class="content">     
        <div class="container-fluid">
        	<ul class="nav nav-tabs" style="margin-top:20px">
        		<c:url var="listUrl" value="/manager/atravels/checkpending"></c:url>
			    <li><a href="${listUrl }">待审批的出差报销单</a></li>
			    <c:url var="priceUrl" value="/manager/atravels/checked"></c:url>
			    <li class="active"><a href="${priceUrl }">已审批的出差报销单</a></li>
			</ul>  
                        ...
                        <!-- row -->
                        	<tr>
	                            ...
	                            <td rowspan="${rbsm.count }">
		                            ...
		                            <c:if test="${rbsm.checked==2 && rbsm.paystatus==0 }">
