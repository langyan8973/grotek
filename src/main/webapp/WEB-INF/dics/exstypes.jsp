...
<c:set var="pageTitle" value="市场开拓费用报销类型管理" scope="request" />
...
<link rel="stylesheet" href="${cssUrlp }" type="text/css" media="screen" />
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${types}" var="type">
                        	<tr>
	                            ...
	                            <td>
	                                <a id="editdept" class="btn btn-mini btn-warning"  href="javascript:edit(${type.id },'${type.name }','${type.label }')">
										编辑
									</a>
		...
		<form id="adddept-form" class="form-horizontal" action="${adddeptUrl }" method="post" enctype="multipart/form-data">
			...
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="span3" name="label" id="label" placeholder="输入标签字符串" 
						style="IME-MODE: disabled;"  maxlength="20"/>
						<span class="help-inline"></span>
					</div>
				</div>
	...
	<div class="modal hide fade" id="editOne-modal" data-backdrop="static" data-keyboard="false">
		<c:url var="editdeptUrl" value="editexstype" />
		<form id="editdept-form" class="form-horizontal" action="${editdeptUrl }" method="post" enctype="multipart/form-data">
			...
			<fieldset>
				<div class="control-group">
					<label class="control-label" for="ename">类型名称</label>
				...
				<div class="control-group">
					<label class="control-label" for="elabel">标签</label>
					<div class="controls">
						<input type="text" class="span3" name="elabel" id="elabel" placeholder="输入标签字符串" 
						style="IME-MODE: disabled;"  maxlength="20"/>
						<span class="help-inline"></span>
					</div>
				</div>
...
function deleteOne(id) {
	bootbox.confirm("确定要删除吗？", "取消", "确定", function(isOk) {
		...
		$.post('<c:url value="deleteexstype" />', {
			id : id
		}).done(function(data) {
