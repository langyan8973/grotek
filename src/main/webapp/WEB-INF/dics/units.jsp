...
<c:set var="pageTitle" value="计量单位管理" scope="request" />
...
<link rel="stylesheet" href="${cssUrlp }" type="text/css" media="screen" />
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${units}" var="unit">
                        	<tr>
	                            ...
	                            <td>
	                                <a id="editdept" class="btn btn-mini btn-warning"  href="javascript:edit(${unit.id },'${unit.name }')">
										编辑
									</a>
									<button class="btn btn-mini btn-danger" type="button" onclick="deleteOne(${unit.id})">删除</button></td>
	                            </td>
	                        </tr>
                        </c:forEach>
                        </tbody>
		...
		<form id="adddept-form" class="form-horizontal" action="${adddeptUrl }" method="post" enctype="multipart/form-data">
			...
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="span3" name="name" id="name" placeholder="输入单位名称" 
	...
	<div class="modal hide fade" id="editOne-modal" data-backdrop="static" data-keyboard="false">
		<c:url var="editdeptUrl" value="editunit" />
		<form id="editdept-form" class="form-horizontal" action="${editdeptUrl }" method="post" enctype="multipart/form-data">
			...
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" class="span3" name="ename" id="ename" placeholder="输入单位名称" 
						style="IME-MODE: disabled;"  maxlength="20"/>
						<span class="help-inline"></span>
					</div>
				</div>
