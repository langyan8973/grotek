...
<c:set var="pageTitle" value="出差报销类型管理" scope="request" />
...
<link rel="stylesheet" href="${cssUrlp }" type="text/css" media="screen" />
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${types}" var="type">
                        	<tr>
	                            ...
	                            <td>
	                                <a id="editdept" class="btn btn-mini btn-warning"  href="javascript:edit(${type.id },'${type.name }')">
										编辑
									</a>
	...
	<div class="modal hide fade" id="editOne-modal" data-backdrop="static" data-keyboard="false">
		<c:url var="editdeptUrl" value="edittravelexstype" />
...
function deleteOne(id) {
	bootbox.confirm("确定要删除吗？", "取消", "确定", function(isOk) {
		...
		$.post('<c:url value="deletetravelexstype" />', {
			id : id
		}).done(function(data) {
