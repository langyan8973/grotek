...
<c:set var="pageTitle" value="原料出库" scope="request" />
    ...
    <div class="content">     
        <div class="container-fluid">
        	<ul class="nav nav-tabs" style="margin-top:20px">
			    ...
			    <li class="active"><a href="${outUrl }">原料出库</a></li>
			</ul>  
                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${outs}" var="out">
                        	<tr>
                        		...
                        		<td>
                        			<c:url var ="proUrl" value = "/manager/productraws/profile?id=${out.productRaw.id }"></c:url>
	                                <a href="${proUrl }" class="name">${out.productRaw.name }</a>
	                            </td>
	                            <td>
	                                ${out.count }(${out.productRaw.unit.name })
	                            </td>
	                            <td>
