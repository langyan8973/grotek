                    ...
                    <table class="table table-bordered">
                        ...
                        <c:forEach items="${ins}" var="in">
                        	<tr>
                        		...
                        		<td>
                        			<c:url var ="proUrl" value = "/manager/productraws/profile?id=${in.productRaw.id }"></c:url>
	                                <a href="${proUrl }" class="name">${in.productRaw.name }</a>
	                            </td>
	                            <td>
	                                ${in.count }(${in.productRaw.unit.name })
	                            </td>
                        	</tr>
                        </c:forEach>                        
                        </tbody>
