...
<c:set var="pageTitle" value="新增出差报销" scope="request" />
...
<link rel="stylesheet" href="${cssUrl }" type="text/css" media="screen" />
    ...
    <div class="workcontent">     
        <div class="container-fluid">   
            ...
            <c:url var="addUrl" value="addtravel" />
	            ...
	            <div class="settings-wrapper" id="pad-wrapper">
	                ...
	                <div class="span8 personal-info">
	                    <h5 class="personal-title">出差报销单</h5>
	                        ...
	                        <div class="field-box">
	                            <label>开始时间:</label>
	                            <input id="stime" name="stime" class="span5 form_datetime" type="text" data-date-format="yyyy-mm-dd" />
	                            <span class="help-inline"></span>
	                        </div>
	                        <div class="field-box">
	                            <label>结束时间:</label>
	                            <input id="etime" name="etime" class="span5 form_datetime" type="text" data-date-format="yyyy-mm-dd" />
	                            <span class="help-inline"></span>
	                        </div>
	                        <div class="field-box">
	                            <label>出发地:</label>
	                            <input id="splace" name="splace" class="span5" type="text" value="" />
	                            <span class="help-inline"></span>
	                        </div>
	                        <div class="field-box">
	                            <label>目的地:</label>
	                            <input id="eplace" name="eplace" class="span5" type="text" value="" />
	                            <span class="help-inline"></span>
	                        </div>
