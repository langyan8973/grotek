...
<c:set var="pageTitle" value="编辑市场开拓费用报销" scope="request" />
...
<link rel="stylesheet" href="${cssUrl }" type="text/css" media="screen" />
    ...
    <div class="workcontent">     
        <div class="container-fluid">   
            ...
            <c:url var="addUrl" value="editexsitem" />
	            ...
	            <div class="settings-wrapper" id="pad-wrapper">
	                ...
	                <div class="span8 personal-info">
	                    <h5 class="personal-title">市场开拓费用报销单</h5>
	                        ...
	                        <div class="field-box">
	                            <label>备注:</label>
	                            <textarea rows="3" path="remarks" name='remarks' id="remarks" class="span5" placeholder="50字以内" maxlength="50">${rbsm.remarks }</textarea>
	                            <span class="help-inline"></span>
	                        </div>
			                     ...
			                     <table id="contenttable" class="table table-bordered span6">
			                         ...
			                         <tbody>
			                        	...
			                        	<tr>
				                            ...
				                            <td>
				                            	<input id='items[${i+100 }].date' name='items[${i+100 }].date' class='span2 inline-input mydate' type='text'
